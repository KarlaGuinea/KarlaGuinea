 ...
 */
 function karlaguinea_theme_scripts() {
     wp_enqueue_style( 'karlaguinea', get_stylesheet_uri() );
 }
 add_action( 'wp_enqueue_scripts', 'karlaguinea_theme_scripts' );
    ...
    function karlaguinea_theme_init(){
        ...
        add_action('after_setup_theme', 'karlaguinea_theme_init');
